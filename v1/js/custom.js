...
$(".core-details").click(function(e) {
       ...
       if($(this).find("h2").html() == "Chronological"){
        $('.bg_circle img').attr('src','images/resume_1.jpg');
        ...
        if($(this).find("h2").html() == "Functional"){
         $('.bg_circle img').attr('src','images/resume_2.jpg');
          $(".core-details").removeClass('red');
          $(this).addClass('red');
       
        }
        if($(this).find("h2").html() == "Combination"){
           $('.bg_circle img').attr('src','images/resume_3.jpg');
            $(".core-details").removeClass('red');
            $(this).addClass('red');
          
        }
        if($(this).find("h2").html() == "Targeted"){
           $('.bg_circle img').attr('src','images/resume_4.jpg');
            $(".core-details").removeClass('red');
            $(this).addClass('red');
        
        }
        if($(this).find("h2").html() == "Mini-Resume"){
            $('.bg_circle img').attr('src','images/resume_5.jpg');
             $(".core-details").removeClass('red');
             $(this).addClass('red');
         
        }
        if($(this).find("h2").html() == "Infographic Resume"){
           $('.bg_circle img').attr('src','images/resume_6.jpg');
            $(".core-details").removeClass('red');
            $(this).addClass('red');
